  ...
  render() {
    ...
    return (
      <ul className="nav">
        ...
        <li className={location.pathname === '/contracts' ? 'active' : null}>
          <Link to="/contracts">
            <i className="pe-7s-photo-gallery"></i>
            <p>Контракты</p>
          </Link>
        </li>
        <li className={location.pathname === '/equipment' ? 'active' : null}>
          <Link to="/equipment">
            <i className="pe-7s-server"></i>
            <p>Оборудование</p>
          </Link>
        </li>
        <li className={location.pathname === '/tasks' ? 'active' : null}>
          <Link to="/tasks">
        ...
        <li className={location.pathname === '/reporting' ? 'active' : null}>
          <Link to="/reporting">
            <i className="pe-7s-bookmarks"></i>
            <p>Отчётность</p>
          </Link>
        </li>
        <li className={location.pathname === '/employees' ? 'active' : null}>
          <Link to="/employees">
